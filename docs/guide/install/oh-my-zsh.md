...
## 配置 Oh-My-Zsh {#configure-oh-my-zsh}
...
### 安装 autojump 插件 {#install-autojump-plugin}
...
### 安装 autosuggestions 插件 {#install-zsh-autosuggestions-plugin}
...
## 卸载 Oh-My-Zsh {#uninstall-oh-my-zsh}
