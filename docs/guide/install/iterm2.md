...
### 设置快速切换快捷键 {#set-hotkey-to-show-or-hide-all-windows}
...
### 设置正确的SSH连接字符集 {#set-correct-ssh-connection-charset}
